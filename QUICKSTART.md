...
The pipelines land with M1+; today you drive the kernel from Python. This makes one real
JUDGE-tier call, validates the output against a schema, and records the trace in lineage:
